...
function LanguageSwitchEntry({
  ...
  return <StyledLanguageSwitchEntry onClick={handleClick} {...{ isCurrent }}>{label}</StyledLanguageSwitchEntry>
}
...
const StyledLanguageSwitchEntry = styled.div(({ isCurrent }: StyledLanguageSwitchEntryProps) => [
  tw`p-2`,
  isCurrent && `
